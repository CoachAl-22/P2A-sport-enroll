...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Public registration was closed on 2026-08-03 with the enrolment engine.
  // Admin creates accounts directly; login and password reset stay for admin,
  // coaches and the athlete portal.
  ...
  // The Stripe payment engine (payment intents, subscriptions, setup intents
  // and the /api/webhook/stripe handler) was removed on 2026-08-03 with the
  // enrolment engine. Payments run through SportsBiz/Ezidebit and Setmore.
  // Historic payments and enrollments rows are untouched; the invoice routes
  // below still read them.
