        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Link href="/">
                <a className="text-2xl font-heading font-bold text-primary-500">Power2ADAPT</a>
              </Link>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-8">Meet Our Coaching Team</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow" data-testid="coach-card-alistair">
              <div className="text-center mb-4">
                ...
                />
                <h4 className="text-xl font-heading font-bold text-gray-900" data-testid="text-coach-name-alistair">Alistair</h4>
                <p className="text-sm text-primary-600 font-medium" data-testid="text-coach-title-alistair">Head Coach</p>
              </div>
            ...
            {/* Coach 2 - Sami */}
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow" data-testid="coach-card-sami">
              <div className="text-center mb-4">
                <img 
                  src={coachSamiImage} 
                ...
                />
                <h4 className="text-xl font-heading font-bold text-gray-900" data-testid="text-coach-name-sami">Sami</h4>
                <p className="text-sm text-primary-600 font-medium" data-testid="text-coach-title-sami">Distance Running Specialist</p>
              </div>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            {/* Coach 3 - Georgia */}
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow" data-testid="coach-card-georgia">
              <div className="text-center mb-4">
                <img 
                ...
                />
                <h4 className="text-xl font-heading font-bold text-gray-900" data-testid="text-coach-name-georgia">Georgia</h4>
                <p className="text-sm text-primary-600 font-medium" data-testid="text-coach-title-georgia">Junior Development Specialist</p>
              </div>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            {/* Coach 4 - Blake */}
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow" data-testid="coach-card-blake">
              <div className="text-center mb-4">
                <img 
                  src={coachBlakeImage} 
                ...
                />
                <h4 className="text-xl font-heading font-bold text-gray-900" data-testid="text-coach-name-blake">Blake</h4>
                <p className="text-sm text-primary-600 font-medium" data-testid="text-coach-title-blake">Distance and Trail Running Specialist</p>
              </div>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            {/* Coach 5 - Miah Noble */}
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow" data-testid="coach-card-miah">
              <div className="text-center mb-4">
                <img 
                  src={coachMiahImage} 
                ...
                />
                <h4 className="text-xl font-heading font-bold text-gray-900" data-testid="text-coach-name-miah">Miah Noble</h4>
                <p className="text-sm text-primary-600 font-medium" data-testid="text-coach-title-miah">Trail Running Specialist</p>
              </div>
              <p className="text-gray-600 text-sm leading-relaxed">
